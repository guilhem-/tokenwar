...
export default {
  ...
  'Un branchement de 10 kW sur le réseau local. Abonnement mensuel proportionnel à la puissance souscrite, plus le kWh consommé.':
    'Una acometida de 10 kW a la red local. Cuota mensual proporcional a la potencia contratada, más el kWh consumido.',
  ...
  'De quoi passer un trou de trésorerie. Commission de 0,4 % par an sur la part non tirée : la banque facture aussi ce que vous n’utilisez pas.':
    'Lo justo para salvar un bache de tesorería. Comisión del 0,4 % anual sobre la parte no dispuesta: el banco también factura lo que no usas.',
  'Prêt d’expansion':
    'Préstamo de expansión',
  'Banque d’investissement':
    'Banco de inversión',
  'Capital amorti chaque trimestre':
    'Capital amortizado cada trimestre',
  'Coût total faible, mais des sorties de trésorerie régulières et lourdes.':
    'Coste total bajo, pero salidas de caja regulares y pesadas.',
  ...
  'Coupon semestriel, capital à maturité':
    'Cupón semestral, capital al vencimiento',
  ...
  'Un taux imbattable, contre une option sur votre capital : à l’échéance le fonds peut convertir, et votre valorisation par action se dilue de 12 %.':
    'Un tipo imbatible, a cambio de una opción sobre tu capital: al vencimiento el fondo puede convertir, y tu valoración por acción se diluye un 12 %.',
  'Crédit de sauvetage':
    'Crédito de rescate',
  'Fonds opportuniste':
    'Fondo oportunista',
  ...
  'Densité inouïe, rayonnement pire encore. Les sondes y fondent aussi vite qu’elles moissonnent.':
    'Densidad inaudita, radiación aún peor. Las sondas se funden allí tan rápido como cosechan.',
  'Amas dense':
    'Cúmulo denso',
  'Des milliers de systèmes serrés. Les collisions y sont fréquentes, les pertes aussi.':
    'Miles de sistemas apretados. Allí las colisiones son frecuentes, y las pérdidas también.',
  'Pouponnière stellaire':
    'Guardería estelar',
  'Du gaz partout, des étoiles en formation. Instable, mais généreux.':
    'Gas por todas partes, estrellas en formación. Inestable, pero generoso.',
  'Vestiges':
    'Vestigios',
  'Quelqu’un est passé avant vous. Ce qu’il reste se récolte sans peine — et sans explication.':
    'Alguien pasó antes que tú. Lo que queda se recolecta sin esfuerzo, y sin explicación.',
  'Bras externe':
    'Brazo exterior',
  'Peu de matière, peu de dangers. La région où l’on reconstitue un essaim décimé.':
    'Poca materia, pocos peligros. La región donde se rehace un enjambre diezmado.',
  'Vide profond':
    'Vacío profundo',
  ...
  'Ces bras ne touchent aucune roche : ils assemblent les engins qui la toucheront — pelles, convoyeurs, et les baies qui porteront le calcul. Une usine d’automobiles peut monter une excavatrice.':
    'Estos brazos no tocan roca alguna: ensamblan las máquinas que sí lo harán — excavadoras, cintas transportadoras y los racks que sostendrán el cálculo. Una fábrica de automóviles puede montar una excavadora.',
  ...
  'L’outillage sort désormais des engins sans rien emprunter à personne. La flotte cesse d’être plafonnée par ce que vos sous-traitants veulent bien prêter : elle grandit d’elle-même.':
    'El utillaje ya produce máquinas sin pedir nada prestado a nadie. La flota deja de estar limitada por lo que tus subcontratistas quieran prestar: crece por sí sola.',
  ...
  'Les engins ont enfin où mordre. La roche arrive brute, en tonnage, au lieu d’être achetée au kilo à des fournisseurs qui la comptent.':
    'Las máquinas por fin tienen dónde morder. La roca llega en bruto, por toneladas, en lugar de comprarse al kilo a proveedores que la cuentan.',
  ...
  'La roche devient du substrat sur place — silicium, métaux, terres rares, prêts à porter du calcul. Ce qui sort de la fosse repart en wafers sans jamais passer par une route.':
    'La roca se convierte en sustrato in situ — silicio, metales, tierras raras, listos para sostener cálculo. Lo que sale de la corta sale en obleas, sin pisar jamás una carretera.',
  ...
  'Plus besoin de fonderie ni de fosse : les assembleurs convertissent la roche là où ils la trouvent. Le rendement cesse de dépendre de ce qu’on a construit, et ne dépend plus que de ce qu’on trouve.':
    'Ya no hacen falta fundición ni corta: los ensambladores convierten la roca allí donde la encuentran. El rendimiento deja de depender de lo construido y solo depende de lo que se encuentra.',
  ...
  'Votre COO note vos décisions : cochez un choix dans un événement et il sera appliqué automatiquement les prochaines fois. Chaque paiement couvre une directive, et la suivante coûte plus cher.':
    'Tu COO anota tus decisiones: marca una opción en un evento y se aplicará automáticamente las próximas veces. Cada pago cubre una directiva, y la siguiente cuesta más.',
  ...
  'produire le plus de tokens possible. Jusqu’où cela mène, vous le découvrirez en jouant.':
    'producir la mayor cantidad de tokens posible. Adónde lleva eso, lo descubrirás jugando.',
  'Pour commencer :':
    'Para empezar:',
  ...
  'un GPU doit tenir dans un serveur, dans une baie, dans un datacenter, sur de l’immobilier — qui consomment aussi de l’énergie. Le matériel obsolète se revend — à l’unité, par dix au-delà de 10 exemplaires, en totalité au-delà de 100 ; une carte sortie depuis plus de 5 ans disparaît du marché. Vous pouvez aussi louer un datacenter ou de l’espace en colocation.':
    'una GPU debe caber en un servidor, en un rack, en un centro de datos, sobre inmuebles, y todos consumen energía. El material obsoleto se revende: de una en una, de diez en diez pasadas 10 unidades, entero pasadas 100; una tarjeta con más de 5 años desaparece del mercado. También puedes alquilar un centro de datos o espacio en colocation.',
  '⚡ Au départ :':
    '⚡ Al principio:',
  'vous n’avez aucune puissance disponible, ni baie ni serveur — seulement un local, une salle et $50 000. Votre première décision est de vous raccorder, puis de monter une baie et un serveur avant de pouvoir loger la moindre carte. Surveillez La Une : une subvention énergie pour les jeunes pousses viendra renforcer votre raccordement.':
    'no tienes potencia disponible, ni rack ni servidor: solo un local, una sala y 50 000 $. Tu primera decisión es conectarte, y luego montar un rack y un servidor antes de poder alojar una sola tarjeta. Vigila la Portada: una subvención energética para empresas jóvenes reforzará tu acometida.',
  '⚡ Coûts d’énergie :':
    '⚡ Costes de energía:',
  ...
  'certaines technologies ne s’achètent pas sur étagère. Elles passent par la recherche, la mise au point, la disponibilité, votre commande, puis le déploiement — chaque étape étant couverte par la presse. Sans programme de fusion abouti, par exemple, aucun réacteur à fusion n’est achetable.':
    'algunas tecnologías no se compran en el estante. Pasan por la investigación, la puesta a punto, la disponibilidad, tu pedido y luego el despliegue, y la prensa cubre cada etapa. Sin un programa de fusión terminado, por ejemplo, ningún reactor de fusión es comprable.',
  '₿ Crypto :':
    '₿ Cripto:',
  ...
  '[[Espace]] vitesse suivante · [[F]] geler / dégeler · [[G]] commander la meilleure carte qu’on puisse s’offrir et loger · [[H]] le niveau d’hébergement qui manque · [[B]] la percée proposée · [[M]] un cran de marketing.':
    '[[Espacio]] velocidad siguiente · [[F]] congelar / descongelar · [[G]] encargar la mejor tarjeta que puedas pagar y alojar · [[H]] el nivel de alojamiento que falta · [[B]] el avance propuesto · [[M]] un escalón de marketing.',
  'Gelé, le temps s’arrête net — ni tokens, ni calendrier, ni entraînement — mais l’interface reste vivante : on peut lire, comparer, acheter. Le dégel rend exactement la vitesse qu’on avait. Rien n’est intercepté pendant qu’on écrit dans un champ, ni sous [[Ctrl]], ni pendant qu’une décision attend. Survolez un chiffre de l’en-tête pour le voir jusqu’au dernier chiffre.':
    'Congelado, el tiempo se detiene en seco — ni tokens, ni calendario, ni entrenamiento — pero la interfaz sigue viva: puedes leer, comparar, comprar. Al descongelar recuperas exactamente la velocidad que tenías. Nada se intercepta mientras escribes en un campo, ni bajo [[Ctrl]], ni mientras una decisión espera. Pasa el ratón por una cifra de la cabecera para verla hasta el último dígito.',
  'Automatisation :':
    'Automatización:',
  ...
  'chaque paiement mémorise **une** décision, ensuite appliquée automatiquement. La directive suivante coûte un cran de plus, et le total est plafonné au nombre d’événements à choix. Remplacer une directive existante ne consomme pas de place.':
    'cada pago memoriza **una** decisión, que después se aplica sola. La siguiente directiva cuesta un escalón más, y el total está limitado al número de eventos con opciones. Sustituir una directiva existente no ocupa plaza.',
  '🏦 Dette :':
    '🏦 Deuda:',
  'dix instruments, du crédit bancaire ordinaire au prêt de sauvetage à 14 %. La ligne n’affiche que le nom, le montant et le taux : **survolez-la** pour voir le prêteur, la durée, la mécanique de remboursement et surtout le **coût total du crédit** — le seul chiffre qui permette de comparer un taux bas amorti dès le premier trimestre à un taux élevé payé in fine. Certaines offres exigent une société cotée ; le fonds opportuniste n’apparaît que lorsque ça va mal. Chaque prêt affiche sa prochaine échéance et son montant, et se rembourse par anticipation depuis sa ligne. **La banque ne perd jamais** : les montants sont libellés en dollars constants, donc l’inflation n’efface pas la dette, et si la trésorerie ne suffit pas à l’échéance, les actifs sont saisis et vendus.':
    'diez instrumentos, del préstamo bancario corriente al crédito de rescate al 14 %. La línea solo muestra el nombre, el importe y el tipo: **pasa el ratón por encima** para ver el prestamista, el plazo, la mecánica de amortización y sobre todo el **coste total del crédito**, la única cifra que permite comparar un tipo bajo amortizado desde el primer trimestre con un tipo alto pagado al vencimiento. Algunas ofertas exigen una empresa cotizada; el fondo oportunista solo aparece cuando las cosas van mal. Cada préstamo muestra su próximo vencimiento y su importe, y se puede amortizar anticipadamente desde su propia línea. **El banco nunca pierde**: los importes están en dólares constantes, así que la inflación no borra la deuda, y si la tesorería no alcanza en la fecha de pago, se embargan y venden activos.',
  'Bourse :':
    'Bolsa:',
  ...
  'répartissez votre compute entre Service, Recherche, Auto-amélioration et Récolte. **C’est la Récolte qui commande la durée de cette phase**, et son effet n’est pas proportionnel : elle agit sur la vitesse à laquelle la boucle s’emballe. À 15 % la phase demande des dizaines de minutes, à 50 % une douzaine, à 100 % moins de dix. La barre de l’en-tête affiche le temps qu’il reste au rythme choisi — si elle passe à l’orange, c’est ce curseur qu’il faut pousser.':
    'reparte tu cómputo entre Servicio, Investigación, Automejora y Recolección. **Es la Recolección la que manda en la duración de esta fase**, y su efecto no es proporcional: actúa sobre la velocidad a la que el bucle se dispara. Al 15 % la fase pide decenas de minutos, al 50 % una docena, al 100 % menos de diez. La barra de la cabecera muestra el tiempo restante al ritmo elegido; si se pone naranja, es ese control el que hay que subir.',
  'Calendrier :':
    'Calendario:',
  ...
  'Ligne ouverte : {0} disponibles chez {1}, à {2} l’an sur les sommes tirées.':
    'Línea abierta: {0} disponibles en {1}, al {2} anual sobre lo dispuesto.',
  '{0} : {1} versés par {2}, à {3} l’an sur {4} ans.':
    '{0}: {1} desembolsados por {2}, al {3} anual durante {4} años.',
  'Échéance de {0} partiellement honorée : {1} reportés, avec intérêts.':
    'Vencimiento de {0} atendido solo en parte: {1} aplazados, con intereses.',
  '{0} convertie en actions : votre valorisation par action se dilue de {1}.':
    '{0} convertida en acciones: tu valoración por acción se diluye un {1}.',
  '{0} soldé. Intérêts versés : {1}.':
    '{0} cancelado. Intereses pagados: {1}.',
  '{0} remboursé par anticipation.':
    '{0} amortizado anticipadamente.',
  'Saisie : {0} d’actifs liquidés pour honorer la dette.':
    'Embargo: {0} en activos liquidados para atender la deuda.',
  ...
  'Directives permanentes activées : {0} mémorisable.':
    'Directivas permanentes activadas: {0} memorizable.',
  'Directive supplémentaire achetée : {0} mémorisables.':
    'Directiva adicional comprada: {0} memorizables.',
  ...
  'Mise à jour des règles : les directives s’achètent à l’unité. Vos {0} places sont conservées.':
    'Actualización de reglas: las directivas se compran de una en una. Se conservan tus {0} plazas.',
  '{0} h {1}':
    '{0} h {1}',
  '{0} min':
    '{0} min',
  ...
  'Aucun hébergement achetable : place ou budget.':
    'Ningún alojamiento comprable: sin hueco o sin presupuesto.',
  'Aucune percée disponible pour l’instant.':
    'Ningún avance disponible por ahora.',
  'Recherche insuffisante pour {0}':
    'Investigación insuficiente para {0}',
  '{0} lancé':
    '{0} iniciado',
  'Marketing : plafond atteint ou trésorerie insuffisante':
    'Marketing: tope alcanzado o tesorería insuficiente',
  'Marketing renforcé':
    'Marketing reforzado',
  'Incident : {0}':
    'Incidente: {0}',
  ...
  'Revendre dix cartes d’un coup':
    'Revender diez tarjetas de una vez',
  'Tout revendre':
    'Revender todo',
  'Revendre la totalité de ce modèle':
    'Revender todas las tarjetas de este modelo',
  ...
  'payez pour une directive de plus (plafond : {0})':
    'paga por una directiva más (tope: {0})',
  'Ne soyez plus jamais interrompu — une directive par paiement, {0} au total.':
    'No vuelvas a ser interrumpido: una directiva por pago, {0} en total.',
  ...
  'Tirer le solde disponible de la ligne':
    'Disponer del saldo restante de la línea',
  'Rembourser':
    'Devolver',
  'Rembourser ce qui est tiré (sans pénalité)':
    'Devolver lo dispuesto (sin penalización)',
  'Solder':
    'Cancelar',
  'Rembourser par anticipation — pénalité de {0}':
    'Amortización anticipada — penalización del {0}',
  'Rembourser tout le capital restant':
    'Devolver todo el capital pendiente',
  'Rembourser 50%':
    'Devolver el 50%',
  'Rembourser la moitié du capital restant':
    'Devolver la mitad del capital pendiente',
  'échéance {0}':
    'vence el {0}',
  'dernière':
    'última',
  ...
  'Quota de directives atteint ({0}/{1}) — payez une directive de plus dans l’Addendum.':
    'Cupo de directivas alcanzado ({0}/{1}): paga una más en el Addendum.',
  ...
  'Vitesse de simulation (Espace) — F pour geler':
    'Velocidad de simulación (Espacio) — F para congelar',
  'Sauvegarder':
    'Guardar',
  'Recommencer depuis le début':
    'Empezar de cero',
