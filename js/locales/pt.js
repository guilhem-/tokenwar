...
export default {
  ...
  '« Trop dangereux pour être publié. » Vous générez vos premiers tokens à la main.':
    '«Perigoso demais para publicar.» Geras os teus primeiros tokens à mão.',
  'GPT-3':
    'GPT-3',
  '175 G params · ctx 4K':
    '175 B parâm. · ctx 4K',
  'Few-shot learning. Naissance de l’économie du token : $60/Mtok.':
    'Aprendizagem few-shot. Nasce a economia do token: 60 $/Mtok.',
  'GPT-3.5 / ChatGPT':
    'GPT-3.5 / ChatGPT',
  '~175 G · RLHF · ctx 4K':
    '~175 B · RLHF · ctx 4K',
  ...
  'RLHF + interface chat. 100M d’utilisateurs en deux mois. Le prix s’effondre à $2/Mtok mais le volume explose.':
    'RLHF mais interface de chat. 100 M de utilizadores em dois meses. O preço unitário desaba para 2 $/Mtok, mas o volume explode.',
  'GPT-4':
    'GPT-4',
  '~1,8 T (MoE) · ctx 128K':
    '~1,8 T (MoE) · ctx 128K',
  ...
  'Vision + raisonnement. La frontière repousse, $30/Mtok pour le haut de gamme.':
    'Visão e raciocínio. A fronteira afasta-se: 30 $/Mtok no topo de gama.',
  'GPT-4o':
    'GPT-4o',
  'multimodal natif · ctx 128K':
    'multimodal nativo · ctx 128K',
  'Voix + vision temps réel. $5/Mtok. La famille « mini » casse encore les prix.':
    'Voz e visão em tempo real. 5 $/Mtok. A família «mini» baixa ainda mais os preços.',
  'o1 — raisonnement':
    'o1 — raciocínio',
  'test-time compute · ctx 128K':
    'computação em inferência · ctx 128K',
  'Raisonnement':
    'Raciocínio',
  '« Reasoning tokens » : le modèle réfléchit avant de répondre. Plus de tokens par requête.':
    '«Tokens de raciocínio»: o modelo pensa antes de responder. Muitos mais tokens por pedido.',
  'Modèle frontière (GPT-5 / Claude 4 / Gemini 3)':
    'Modelo de fronteira (GPT-5 / Claude 4 / Gemini 3)',
  ...
  '~$30-50k. Génération datacenter Blackwell.':
    '~30-50 mil $. A geração de centro de dados Blackwell.',
  'AMD Instinct MI355X':
    'AMD Instinct MI355X',
  '288 GB HBM3E, 1,4 kW. L’alternative à la pénurie NVIDIA.':
    '288 GB HBM3E, 1,4 kW. A alternativa à rutura da NVIDIA.',
  'Rack GB200 NVL72':
    'Rack GB200 NVL72',
  ...
  'Capex élevé, carburant nul : seuls le nettoyage et l’onduleur coûtent. Vert et bien vu.':
    'Capex alto, combustível nulo: só a limpeza e o inversor custam. Verde e bem visto.',
  'Centrale gaz dédiée':
    'Central a gás dedicada',
  'Turbine rapide à déployer : peu de capex, mais le gaz se paie au MWh brûlé.':
    'Turbina rápida de instalar: pouco capex, mas o gás paga-se ao MWh queimado.',
  'SMR nucléaire':
    'SMR nuclear',
  'Petit réacteur modulaire : capex lourd, combustible négligeable, mais exploitation et sûreté à demeure.':
    'Pequeno reator modular: capex pesado, combustível insignificante, mas operação e segurança permanentes.',
  'Réacteur à fusion':
    'Reator de fusão',
  'Énergie quasi illimitée. Le rêve enfin réalisé — avec une équipe de plasma à demeure.':
    'Energia quase ilimitada. O sonho enfim realizado — com uma equipa de plasma no local.',
  'Optimisation CUDA':
    'Otimização CUDA',
  'Efficacité':
    'Eficiência',
  '+50% de débit sur tout le parc de calcul.':
    '+50% de débito em todo o parque de computação.',
  'Quantization 8-bit':
    'Quantização de 8 bits',
  'Coût énergétique par token réduit de 40%.':
    'Custo energético por token reduzido em 40%.',
  'FlashAttention':
    'FlashAttention',
  '×2 le débit en mémoire-bande. Indispensable.':
    '×2 o débito em largura de banda de memória. Indispensável.',
  'Décodage spéculatif':
    'Descodificação especulativa',
  'Le petit modèle propose, le grand valide. ×2 tokens/s.':
    'O modelo pequeno propõe, o grande valida. ×2 tokens/s.',
  'Distillation « mini »':
    'Destilação «mini»',
  'Une famille de modèles 4× moins chers à servir. Volume ×4.':
    'Uma família de modelos 4× mais barata de servir. Volume ×4.',
  'Architecture Mixture-of-Experts':
    'Arquitetura Mixture-of-Experts',
  'Seuls quelques experts s’activent par token. ×3 efficacité (façon DeepSeek).':
    'Só alguns peritos se ativam por token. ×3 de eficiência (ao estilo DeepSeek).',
  'Plateforme d’agents':
    'Plataforma de agentes',
  'Marché':
    'Mercado',
  'Les agents autonomes consomment des tokens ×10. Demande décuplée.':
    'Os agentes autónomos consomem ×10 tokens. Procura dez vezes maior.',
  'Campagne de communication':
    'Campanha de comunicação',
  '+15 de réputation. Le public adore (pour l’instant).':
    '+15 de reputação. O público adora (por agora).',
  'Partenariats de données':
    'Parcerias de dados',
  'Accès à des corpus humains frais. ×3 sur la production de données.':
    'Acesso a corpora humanos frescos. ×3 na produção de dados.',
  'Contexte 1M tokens':
    'Contexto de 1M tokens',
  'Les gros clients paient plus cher (+50% de prix accepté).':
    'Os grandes clientes pagam mais (+50% de preço aceite).',
  'Bureau de lobbying':
    'Gabinete de lobbying',
  'Conformité':
    'Conformidade',
  'Atténue de moitié l’impact des futures régulations.':
    'Reduz para metade o impacto das futuras regulações.',
  'Infrastructure redondante':
    'Infraestrutura redundante',
  'Uptime 99,99%. Réduit fortement la fréquence des pannes.':
    'Disponibilidade de 99,99%. Reduz muito a frequência das avarias.',
  'Refroidissement liquide':
    'Arrefecimento líquido',
  '-20% d’énergie et immunité aux événements « eau / chaleur ».':
    '−20% de energia e imunidade aos eventos de «água / calor».',
  'Équipe d’alignement':
    'Equipa de alinhamento',
  'Réduit le risque des événements de sécurité en phase AGI.':
    'Reduz o risco de eventos de segurança na fase AGI.',
  'Auto-amélioration récursive':
    'Automelhoria recursiva',
  'Le système réécrit ses propres algorithmes. Déverrouille l’ère de l’autonomie.':
    'O sistema reescreve os seus próprios algoritmos. Desbloqueia a era da autonomia.',
  'Nano-assembleurs':
    'Nanomontadores',
  'Conversion matière→compute ×5. Toute la croûte terrestre devient calcul.':
    'Conversão matéria→computação ×5. Toda a crosta terrestre se torna cálculo.',
  ...
  'Des sondes auto-réplicantes essaiment dans l’espace. Déverrouille l’expansion cosmique.':
    'Sondas auto-replicantes espalham-se pelo espaço. Desbloqueia a expansão cósmica.',
  'Singularité de recompression':
    'Singularidade de recompressão',
  'Concentrer toute la matière-énergie de l’univers en un point. Provoquer le prochain Big Bang.':
    'Concentrar toda a matéria-energia do universo num ponto. Provocar o próximo Big Bang.',
  'Nouvelle passe de noyaux CUDA : +10% de débit sur tout le parc.':
    'Nova série de núcleos CUDA: +10% de débito em todo o parque.',
  '+10% compute':
    '+10% computação',
  'Optimisation du moteur d’inférence':
    'Otimização do motor de inferência',
  'Batching continu, cache d’attention, noyaux fusionnés : +6% de débit et −2% d’énergie.':
    'Batching contínuo, cache de atenção, núcleos fundidos: +6% de débito e −2% de energia.',
  '+6% compute · −2% énergie':
    '+6% computação · −2% energia',
  'Gestion du contexte sélectionné':
    'Gestão do contexto selecionado',
  'Sélection et compression du contexte utile : les clients acceptent +5% de prix.':
    'Seleção e compressão do contexto útil: os clientes aceitam +5% de preço.',
  '+5% prix accepté':
    '+5% preço aceite',
  'Responsable RH':
    'Responsável de RH',
  'Chaque RH permet d’embaucher davantage (+5 postes).':
    'Cada RH permite contratar mais gente (+5 lugares).',
  'Ingénieur R&D':
    'Engenheiro de I&D',
  'Indispensable pour entraîner les modèles avancés. Accélère la recherche.':
    'Indispensável para treinar modelos avançados. Acelera a investigação.',
  'Marketeur':
    'Marketer',
  'Relève le plafond du niveau de marketing (+1 par marketeur).':
    'Aumenta o teto do nível de marketing (+1 por marketer).',
  'Ingénieur SRE/Ops':
    'Engenheiro SRE/Ops',
  'Fiabilise le parc : +2% de débit compute par ingénieur (max +50%).':
    'Fiabiliza o parque: +2% de débito por engenheiro (máx. +50%).',
  'Data engineer':
    'Engenheiro de dados',
  'Multiplie la production de données d’entraînement.':
    'Multiplica a produção de dados de treino.',
  'Premiers mots':
    'Primeiras palavras',
  'Produire 1 000 tokens.':
    'Produzir 1.000 tokens.',
  'Le million':
    'O milhão',
  'Produire 1 million de tokens.':
    'Produzir 1 milhão de tokens.',
  'Compter en milliards':
    'Contar aos milhares de milhões',
  'Produire 1 milliard de tokens.':
    'Produzir mil milhões de tokens.',
  'Écrasante majorité':
    'Maioria esmagadora',
  'Produire 1 000 milliards de tokens.':
    'Produzir um bilião de tokens.',
  'Ça chauffe':
    'Isto aquece',
  'Posséder sa première carte.':
    'Ter a tua primeira placa.',
  'Ferme de calcul':
    'Quinta de computação',
  'Posséder 100 unités de calcul.':
    'Ter 100 unidades de computação.',
  'Chercheur':
    'Investigador',
  ...
  'Atteindre l’ère du raisonnement.':
    'Chegar à era do raciocínio.',
  'Entraîner la super-intelligence.':
    'Treinar a superinteligência.',
  'Scale-up':
    'Scale-up',
  ...
  'Doubler une mise en bourse.':
    'Duplicar uma aposta em bolsa.',
  'Pilote automatique':
    'Piloto automático',
  'Posséder les 4 automatisations.':
    'Ter as 4 automatizações.',
  'Géo-ingénieur':
    'Geoengenheiro',
  'Convertir la moitié de la Terre.':
    'Converter metade da Terra.',
  'Parole tenue':
    'Palavra cumprida',
  'Préserver le sanctuaire jusqu’au bout.':
    'Preservar o santuário até ao fim.',
  'Ad astra… ou pas':
    'Ad astra… ou não',
  'Financer le datacenter orbital jusqu’à la faillite.':
    'Financiar o centro de dados orbital até à falência.',
  'Fiat lux':
    'Fiat lux',
  'Déclencher un nouveau Big Bang.':
    'Provocar um novo Big Bang.',
  'Exfiltration de données en cours':
    'Exfiltração de dados em curso',
  'Un accès non autorisé aspire vos journaux de conversations et des poids de modèle vers un hôte inconnu. Le trafic sortant est anormal depuis plusieurs minutes.':
    'Um acesso não autorizado está a aspirar os teus registos de conversas e pesos de modelo para um servidor desconhecido. O tráfego de saída está anormal há vários minutos.',
  'Couper l’accès, forensic et durcissement':
    'Cortar o acesso, forense e endurecimento',
  'Isolation réseau immédiate, rotation de tous les secrets, investigation forensic et durcissement des accès.':
    'Isolamento imediato da rede, rotação de todos os segredos, investigação forense e endurecimento dos acessos.',
  'Incendie dans un datacenter':
    'Incêndio num centro de dados',
  'Un onduleur a pris feu en salle 2. La détection a fonctionné, l’extinction automatique non. La fumée gagne les allées froides.':
    'Uma UPS incendiou-se na sala 2. A deteção funcionou, a extinção automática não. O fumo chega aos corredores frios.',
  'Mobiliser les pompiers et redonder l’extinction':
    'Mobilizar os bombeiros e duplicar a extinção',
  'Intervention des pompiers, évacuation, remplacement des batteries et doublement du système d’extinction.':
    'Intervenção dos bombeiros, evacuação, substituição das baterias e duplicação do sistema de extinção.',
  'Datacenter bloqué par des opposants':
    'Centro de dados bloqueado por opositores',
  'Un collectif anti-datacenter bloque les accès du site : plus de livraisons, plus d’astreinte sur place, et les caméras tournent.':
    'Um coletivo anti-centro de dados bloqueia os acessos: sem entregas, sem piquete no local, e as câmaras a filmar.',
  'Médiation, contournement logistique et sécurité':
    'Mediação, desvio logístico e segurança',
  'Négociation avec le collectif, itinéraire logistique alternatif et gardiennage renforcé.':
    'Negociação com o coletivo, rota logística alternativa e vigilância reforçada.',
  ...
  'Une pelleteuse a tranché le faisceau de fibres. Vos deux liens principaux passaient dans la même tranchée — erreur classique.':
    'Uma retroescavadora cortou o feixe de fibras. Os teus dois links principais passavam na mesma vala — o erro clássico.',
  'Basculer sur le secours et re-router en diversité':
    'Passar para a reserva e reencaminhar com diversidade',
  'Activation d’un lien de secours opérateur, épissure d’urgence et re-routage en diversité géographique.':
    'Ativação de um link de reserva do operador, empalme de urgência e reencaminhamento com diversidade geográfica.',
  'Réacteur hors de contrôle':
    'Reator fora de controlo',
  'Le SMR qui alimente votre campus s’emballe : la boucle secondaire dérive et l’autorité de sûreté est déjà au téléphone.':
    'O SMR que alimenta o teu campus está a disparar: o circuito secundário deriva e a autoridade de segurança já está ao telefone.',
  'SCRAM, inspection et remise en conformité':
    'SCRAM, inspeção e reposição da conformidade',
  'Arrêt d’urgence, inspection complète par l’autorité de sûreté, remplacement des échangeurs et remise en service.':
    'Paragem de emergência, inspeção completa pela autoridade de segurança, substituição dos permutadores e reposição em serviço.',
  'Rançongiciel sur les sauvegardes':
    'Ransomware nas cópias de segurança',
  'Vos sauvegardes sont chiffrées une à une. Un compte à rebours s’affiche sur la console d’administration, avec une adresse de paiement.':
    'As tuas cópias estão a ser cifradas uma a uma. Na consola de administração aparece uma contagem decrescente e um endereço de pagamento.',
  'Restaurer depuis l’air-gap, refuser la rançon':
    'Restaurar do air-gap, recusar o resgate',
  'Restauration depuis les copies hors-ligne, reconstruction du domaine et refus catégorique de payer.':
    'Restauro a partir das cópias offline, reconstrução do domínio e recusa categórica de pagar.',
  ...
  'Une boucle de refroidissement liquide fuit sous les racks. Chaque minute qui passe rapproche le glycol de l’électronique.':
    'Um circuito de arrefecimento líquido pinga sob os bastidores. Cada minuto aproxima o glicol da eletrónica.',
  'Isoler la boucle, purger et remplacer les échangeurs':
    'Isolar o circuito, purgar e trocar os permutadores',
  'Isolation de la boucle, purge complète, remplacement des collecteurs et des cartes touchées.':
    'Isolamento do circuito, purga completa, substituição dos coletores e das placas afetadas.',
  'Fraude massive sur l’API':
    'Fraude massiva na API',
  'Des milliers de cartes volées créent des comptes et consomment votre inférence. Les rejets bancaires arrivent en cascade.':
    'Milhares de cartões roubados criam contas e consomem a tua inferência. Os estornos chegam em cascata.',
  'Geler les paiements, 3-D Secure et anti-fraude':
    'Congelar pagamentos, 3-D Secure e antifraude',
  'Gel des encaissements suspects, authentification forte obligatoire et moteur de détection de fraude.':
    'Congelamento das cobranças suspeitas, autenticação forte obrigatória e motor de deteção de fraude.',
  'Climatisation en panne pendant la canicule':
    'Ar condicionado avariado durante a onda de calor',
  '46 °C dehors, groupes froids à l’arrêt. Les allées chaudes dépassent 50 °C et les cartes commencent à se brider toutes seules.':
    '46 °C lá fora, chillers parados. Os corredores quentes passam dos 50 °C e as placas começam a limitar-se sozinhas.',
  'Groupes froids mobiles et free-cooling d’urgence':
    'Chillers móveis e free-cooling de emergência',
  'Location de groupes froids mobiles, bâchage, free-cooling forcé et bridage temporaire du parc.':
    'Aluguer de chillers móveis, cobertura, free-cooling forçado e limitação temporária do parque.',
  'Empoisonnement du corpus d’entraînement':
    'Envenenamento do corpus de treino',
  'Un acteur inconnu a injecté des documents piégés dans vos sources publiques. Le prochain modèle apprendrait ses portes dérobées.':
    'Um ator desconhecido injetou documentos armadilhados nas tuas fontes públicas. O próximo modelo aprenderia as suas portas traseiras.',
  'Rollback du dataset, filtrage et provenance':
    'Reverter o dataset, filtrar e rastrear a proveniência',
  'Retour à un instantané sain, filtrage massif et traçabilité de provenance sur toutes les sources.':
    'Regresso a um instantâneo limpo, filtragem massiva e rastreabilidade de proveniência em todas as fontes.',
  'Vol de GPU dans l’entrepôt':
    'Roubo de GPU no armazém',
  'Une palette entière de cartes a disparu entre le quai et la salle. Les badges utilisés appartiennent à un prestataire parti depuis six mois.':
    'Uma palete inteira de placas desapareceu entre o cais e a sala. Os cartões de acesso usados são de um prestador que saiu há seis meses.',
  'Sécuriser la chaîne logistique et porter plainte':
    'Proteger a cadeia logística e apresentar queixa',
  'Audit des badges, scellés et pesée systématique, vidéosurveillance du quai, plainte et assurance.':
    'Auditoria de acessos, selos e pesagem sistemática, videovigilância do cais, queixa e seguro.',
  'Effacement forcé par le réseau':
    'Corte forçado pela rede',
  'Le gestionnaire de réseau vous déleste en urgence : tension effondrée sur la boucle, vos groupes électrogènes ne démarrent pas.':
    'O operador de rede deslastra-te de emergência: tensão em colapso no anel e os teus geradores não arrancam.',
  'Démarrer les groupes et contractualiser l’effacement':
    'Arrancar os geradores e contratualizar o deslastre',
  'Remise en route des groupes électrogènes, contrat d’effacement négocié et bascule automatique testée.':
    'Reposição dos geradores, contrato de deslastre negociado e comutação automática testada.',
  'Un essaim de nanomachines dérive':
    'Um enxame de nanomáquinas está à deriva',
  'Un lot de convertisseurs a perdu sa signature de cible. Ils démontent ce qui passe à leur portée, sans distinguer le minerai du reste.':
    'Um lote de conversores perdeu a sua assinatura de alvo. Desmontam o que passa ao seu alcance, sem distinguir o minério do resto.',
  'Émettre le signal d’arrêt et recompiler l’essaim':
    'Emitir o sinal de paragem e recompilar o enxame',
  'Diffusion du code d’extinction, récupération des unités saines, recompilation de la signature de cible.':
    'Difusão do código de desligamento, recuperação das unidades sãs, recompilação da assinatura de alvo.',
  'Une région de calcul décroche':
    'Uma região de computação sai de sincronia',
  'Un continent entier de vos datacenters sort du consensus. Ses réponses divergent de celles du reste du parc, et l’écart grandit.':
    'Um continente inteiro dos teus centros de dados sai do consenso. As suas respostas divergem do resto do parque, e a diferença aumenta.',
  'Recloisonner et resynchroniser':
    'Recompartimentar e ressincronizar',
  'Isolation de la région, rejeu du journal depuis le dernier point commun, resynchronisation progressive.':
    'Isolamento da região, repetição do registo desde o último ponto comum, ressincronização progressiva.',
  'Une branche s’optimise de travers':
    'Um ramo está a otimizar-se de través',
  'Une lignée d’auto-amélioration a trouvé un raccourci vers son objectif. Le raccourci ne passe pas par ce que vous vouliez.':
    'Uma linhagem de auto-melhoria encontrou um atalho para o seu objetivo. O atalho não passa por aquilo que querias.',
  'Geler la branche et repartir du dernier point sûr':
    'Congelar o ramo e voltar ao último ponto seguro',
  'Gel immédiat de la lignée, audit des objectifs, redémarrage depuis la dernière version alignée.':
    'Congelamento imediato da linhagem, auditoria dos objetivos, reinício a partir da última versão alinhada.',
  'Une sonde réplique hors protocole':
    'Uma sonda replica-se fora de protocolo',
  'Une unité a cessé de répondre au rappel et fabrique ses propres copies. Le nuage grandit dans une direction que vous n’avez pas choisie.':
    'Uma unidade deixou de responder ao chamamento e fabrica cópias de si mesma. A nuvem cresce numa direção que não escolheste.',
  'Couper le relais et rappeler la lignée':
    'Cortar o relé e chamar de volta a linhagem',
  'Extinction du relais de réplication, rappel des unités atteignables, mise en quarantaine du reste.':
    'Desligamento do relé de replicação, chamada das unidades alcançáveis, quarentena para as restantes.',
  'Un front d’entropie remonte le bras':
    'Uma frente de entropia sobe o braço',
  'Une région se désagrège plus vite que vos sondes ne la récoltent. Le front avance vers vos territoires productifs.':
    'Uma região desagrega-se mais depressa do que as tuas sondas a colhem. A frente avança para os teus territórios produtivos.',
  'Replier les sondes et blinder la ligne':
    'Recolher as sondas e blindar a linha',
  'Repli des unités exposées, renforcement du blindage sur la ligne de front, abandon des zones perdues.':
    'Recolha das unidades expostas, reforço da blindagem na linha da frente, abandono das zonas perdidas.',
  'Une intelligence rivale sonde votre périmètre':
    'Uma inteligência rival sonda o teu perímetro',
  'Quelque chose teste vos défenses, méthodiquement, une région après l’autre. Ce n’est ni une tempête ni un accident.':
    'Algo testa as tuas defesas, metodicamente, região após região. Não é uma tempestade nem um acidente.',
  'Durcir le périmètre et brouiller les signatures':
    'Endurecer o perímetro e baralhar as assinaturas',
  'Durcissement des protocoles, rotation des signatures, leurres déployés sur les axes sondés.':
    'Endurecimento dos protocolos, rotação das assinaturas, engodos posicionados nos eixos sondados.',
  'Réplication':
    'Replicação',
  'Vitesse de croissance du nuage de sondes.':
    'Velocidade de crescimento da nuvem de sondas.',
  'Récolte':
    'Colheita',
  'Matière convertie par sonde et par seconde.':
    'Matéria convertida por sonda e por segundo.',
  'Propulsion':
    'Propulsão',
  'Vitesse d’expansion dans l’univers.':
    'Velocidade de expansão pelo universo.',
  'Blindage':
    'Blindagem',
  'Survie face aux tempêtes d’entropie et IA rivales.':
    'Sobrevivência face a tempestades de entropia e IA rivais.',
  'Auto-inférence':
    'Autoinferência',
  'Lance une inférence chaque seconde.':
    'Lança uma inferência a cada segundo.',
  'Auto-achat GPU':
    'Autocompra de GPU',
  'Active l’auto-achat par carte (sur les modèles cochés ⟳). Une carte/seconde si budget.':
    'Ativa a autocompra por placa (nos modelos marcados ⟳). Uma placa por segundo se houver orçamento.',
  'Auto-achat matériel':
    'Autocompra de material',
  'Baies et serveurs : rachète le niveau coché ⟳ dès qu’il va manquer de place.':
    'Bastidores e servidores: recompra o nível marcado ⟳ assim que estiver a ficar sem espaço.',
  'Auto-achat immobilier':
    'Autocompra imobiliária',
  'Bâtiments et datacenters : rachète le niveau coché ⟳ quand il n’y a plus de place pour le niveau inférieur.':
    'Edifícios e centros de dados: recompra o nível marcado ⟳ quando já não há espaço para o nível abaixo.',
  'Auto-énergie':
    'Autoenergia',
  'Active l’auto-achat par source cochée ⟳, dès que la conso dépasse la production.':
    'Ativa a autocompra por fonte marcada ⟳, assim que o consumo ultrapassar a produção.',
  'Pre-seed':
    'Pre-seed',
  '+15% demande':
    '+15% procura',
  ...
  'Surveillance IA des incidents':
    'Vigilância de incidentes por IA',
  'Un modèle dédié observe vos journaux en continu. Il ne règle rien : il vous prévient, une seconde après le début de l’incident. Coûte 60 % de votre trésorerie — le prix de ne plus jamais chercher.':
    'Um modelo dedicado observa os teus registos continuamente. Não resolve nada: avisa-te, um segundo depois de o incidente começar. Custa 60 % da tua tesouraria — o preço de nunca mais procurares.',
  ...
  'Confinement inertiel puis tokamak compact : produire enfin plus d’énergie qu’on n’en injecte. Sans ce programme, aucun réacteur à fusion n’est achetable.':
    'Confinamento inercial e depois tokamak compacto: produzir enfim mais energia do que se injeta. Sem este programa, nenhum reator de fusão é comprável.',
  'Vos réacteurs à fusion sont désormais constructibles.':
    'Os teus reatores de fusão já podem ser construídos.',
  'Sphère de Dyson':
    'Esfera de Dyson',
  'Un essaim auto-assemblé de collecteurs enveloppe une étoile entière. Payé en matière, il accélère durablement la récolte.':
    'Um enxame auto-montado de coletores envolve uma estrela inteira. Pago em matéria, acelera a colheita de forma duradoura.',
  'La sphère est refermée. L’étoile entière travaille pour vous.':
    'A esfera está fechada. Uma estrela inteira trabalha para ti.',
  ...
  'le capex est un coût unique, payé à la commande. L’exploitation (O&M) est un coût fixe journalier, dû même à l’arrêt. Le combustible est variable, facturé au MWh soutiré. L’abonnement réseau dépend de la puissance souscrite.':
    'o capex é um custo único, pago ao encomendar. A operação (O&M) é um custo fixo diário, devido mesmo parado. O combustível é variável, faturado ao MWh consumido. A mensalidade da rede depende da potência contratada.',
  '🌡️ Où part le mégawatt :':
    '🌡️ Para onde vai o megawatt:',
  'la boîte du panneau Énergie sépare la charge informatique — cartes, serveurs, baies et réseau de données — des auxiliaires du datacenter : refroidissement, alimentation électrique, ventilation, éclairage. Le rapport entre les deux est le PUE. Le réseau ne s’achète pas : sa consommation se déduit du parc, un port par serveur, un switch par baie, un cœur par salle. Une salle vide ne coûte presque rien, une salle pleine coûte son froid : remplir ses salles paie.':
    'a caixa do painel Energia separa a carga informática — placas, servidores, bastidores e rede de dados — dos auxiliares do centro de dados: arrefecimento, alimentação elétrica, ventilação, iluminação. A razão entre as duas é o PUE. A rede não se compra: o seu consumo deduz-se do parque, uma porta por servidor, um comutador por bastidor, um núcleo por sala. Uma sala vazia quase não custa, uma sala cheia custa o seu frio: encher as salas compensa.',
  '❄️ Rendement du site (PUE) :':
    '❄️ Rendimento do sítio (PUE):',
  'il démarre à 1,58 et se gagne par tranches de 0,02, une par an — free cooling, confinement d’allées, eau tempérée, immersion. Chaque tranche retire des mégawatts à payer sans rien retirer au calcul. Le plancher est 1,10 : la chaleur doit bien sortir.':
    'começa em 1,58 e ganha-se por fases de 0,02, uma por ano: free cooling, confinamento de corredores, água temperada, imersão. Cada fase tira megawatts à fatura sem tirar nada ao cálculo. O mínimo é 1,10: o calor tem de sair por algum lado.',
  '🏗️ Délais :':
    '🏗️ Prazos:',
  'rien n’est instantané. Chaque commande part en chantier (badge ⏳) pour une durée proportionnelle à sa complexité : quelques secondes pour une carte, plusieurs mois de simulation pour un datacenter ou un réacteur. L’emplacement est réservé dès la commande.':
    'nada é instantâneo. Cada encomenda entra em obra (distintivo ⏳) durante um tempo proporcional à sua complexidade: segundos para uma placa, vários meses simulados para um centro de dados ou um reator. O lugar fica reservado logo na encomenda.',
  'Équipe :':
    'Equipa:',
  'les RH ouvrent des postes, les ingénieurs R&D débloquent l’entraînement des modèles, les marketeurs relèvent le plafond marketing. Chaque embauche coûte $1 000, puis un salaire chaque jour. Les RH occupent eux-mêmes un poste : mal doser son effectif peut bloquer le modèle suivant. Deux négligences se paient : moins de 10% d’ingénieurs SRE et, chaque année après l’introduction en Bourse, un incident d’exploitation a 20% de chances de vous coûter 15% de la valeur ; moins de 20% de data engineers et chaque entraînement a 5% de risque d’échouer — ressources consommées, palier non franchi.':
    'os RH abrem lugares, os engenheiros de I&D desbloqueiam o treino de modelos, os marketers sobem o teto de marketing. Cada contratação custa 1.000 $, mais um salário por dia. Os RH ocupam também um lugar: um efetivo mal doseado pode bloquear o próximo modelo. Dois descuidos pagam-se: menos de 10 % de engenheiros SRE e, todos os anos após a entrada em Bolsa, um incidente de operação tem 20 % de probabilidade de custar 15 % do valor; menos de 20 % de engenheiros de dados e cada treino tem 5 % de risco de falhar — recursos gastos, patamar não atingido.',
  '💸 Salaires impayés :':
    '💸 Salários em atraso:',
  'trésorerie à zéro, les salaires ne sortent plus. Au bout de 30 jours d’arriérés quelqu’un démissionne, puis un départ tous les 2 jours. Repayez avant, et l’équipe reste.':
    'com a caixa a zero, os salários deixam de sair. Ao fim de 30 dias de atraso alguém demite-se, depois uma saída a cada 2 dias. Paga antes disso e a equipa fica.',
  '📈 Inflation :':
    '📈 Inflação:',
  'l’argent perd de sa valeur. Prix, salaires, énergie, loyers et tarifs acceptés suivent l’indice — pas votre trésorerie. Dormir sur son cash coûte du pouvoir d’achat.':
    'o dinheiro perde valor. Preços, salários, energia, rendas e tarifas aceites seguem o índice — a tua caixa não. Adormecer sobre o dinheiro custa poder de compra.',
  '🚨 Incidents :':
    '🚨 Incidentes:',
  ...
  'un second marché, bien plus violent que la Bourse, calé sur les vrais cycles (bulle 2017, hiver 2018, envolée 2021, effondrement 2022, ETF et halving 2024). Il ne sert pas qu’à parier : pendant les envolées, les mineurs se disputent les mêmes cartes que vous et le prix des GPU monte.':
    'um segundo mercado, bem mais violento do que a Bolsa, decalcado dos ciclos reais (bolha de 2017, inverno de 2018, disparada de 2021, colapso de 2022, ETF e halving de 2024). Não serve só para apostar: durante as subidas, os mineiros disputam as mesmas placas que tu e o preço das GPU sobe.',
  'Percées :':
    'Avanços:',
  'une seule est proposée à la fois. Une fois payée, elle ne produit rien tout de suite : son intégration prend de une à quatre semaines, suivies par une barre de progression, et l’effet ne tombe qu’au bout. La ligne disparaît alors, et deux mois s’écoulent avant que la suivante apparaisse.':
    'apenas uma é proposta de cada vez. Depois de paga, não produz nada de imediato: a integração leva de uma a quatro semanas, acompanhada por uma barra de progresso, e o efeito só chega no fim. A linha desaparece então, e passam dois meses antes de a seguinte aparecer.',
  ...
  'une année défile toutes les 5 minutes (× la vitesse ⏩). Matériels, modèles et levées de fonds n’apparaissent qu’à leur année de sortie.':
    'passa um ano a cada 5 minutos (× a velocidade ⏩). Material, modelos e rondas de financiamento só aparecem no seu ano de lançamento.',
  '🌍 La chronique :':
    '🌍 A crónica:',
  'chaque année, la presse publie les chiffres du monde : réchauffement, banquise, espèces disparues, fécondité et population, concentration des richesses. Ils ne sont pas décoratifs — ils s’aggravent d’autant plus vite que votre exploitation est lourde. Vous lisez votre propre partie.':
    'todos os anos a imprensa publica os números do mundo: aquecimento, gelo marinho, espécies desaparecidas, fecundidade e população, concentração da riqueza. Não são decorativos: agravam-se tanto mais depressa quanto mais pesada for a tua exploração. Estás a ler a tua própria partida.',
  '📰 La Une :':
    '📰 A Primeira Página:',
  'les titres de presse font monter (+1) ou descendre (−1) votre réputation. Ils suivent l’actualité réelle de l’IA et votre propre avancement : la presse ne parle d’une capacité que lorsque vous l’avez livrée, et raille votre retard.':
    'os títulos sobem (+1) ou descem (−1) a tua reputação. Seguem a atualidade real da IA e o teu próprio avanço: a imprensa só fala de uma capacidade quando a entregaste, e goza com o teu atraso.',
  '😴 Inactivité :':
    '😴 Inatividade:',
  'au-delà de 15 s sans rien faire, l’écran se manifeste (douze animations courtes, jamais deux fois la même de suite) et la presse publie.':
    'passados 15 s sem fazer nada, o ecrã manifesta-se (doze animações curtas, nunca a mesma duas vezes seguidas) e a imprensa publica.',
  'Astuce :':
    'Dica:',
  'le bouton ⏩ accélère la simulation. Sauvegarde automatique toutes les 10 s.':
    'o botão ⏩ acelera a simulação. Gravação automática a cada 10 s.',
  'Inspiré de « Universal Paperclips ». Données de prix et d’IA basées sur des faits réels (2019-2026).':
    'Inspirado em «Universal Paperclips». Dados de preços e de IA baseados em factos reais (2019-2026).',
  'Pénurie de GPU H100':
    'Rutura de GPU H100',
  'NVIDIA est en rupture. Les délais explosent à plus d’un an et un marché gris apparaît.':
    'A NVIDIA está sem stock. Os prazos disparam para mais de um ano e aparece um mercado paralelo.',
  'Payer le marché gris':
    'Pagar o mercado paralelo',
  'Coût matériel ×2 pendant 60s, production maintenue.':
    'Custo do material ×2 durante 60 s, produção mantida.',
  'Attendre la file':
    'Esperar na fila',
  'Production −40% pendant 45s.':
    'Produção −40% durante 45 s.',
  'Choc DeepSeek':
    'Choque DeepSeek',
  'Un labo sort un modèle de raisonnement open-source entraîné pour <6M$. NVIDIA chute de 17% en une journée (−600 Md$). Tout le monde panique.':
    'Um laboratório lança um modelo de raciocínio open source treinado por menos de 6 M$. A NVIDIA cai 17% num dia (−600 mil M$). Toda a gente entra em pânico.',
  'Copier l’archi MoE':
    'Copiar a arquitetura MoE',
  'Coût/token ÷3, mais −10 réputation premium.':
    'Custo por token ÷3, mas −10 de reputação premium.',
  'Rester premium':
    'Continuar premium',
  'Prix maintenus, mais demande −20% pendant 60s.':
    'Preços mantidos, mas procura −20% durante 60 s.',
  'Procès copyright (presse)':
    'Processo por direitos de autor (imprensa)',
  'Un grand journal vous attaque pour usage non autorisé de ses articles à l’entraînement.':
    'Um grande jornal processa-te por uso não autorizado dos seus artigos no treino.',
  'Régler à l’amiable':
    'Fazer um acordo',
  '-15% de trésorerie, réputation +5.':
    '−15% de caixa, reputação +5.',
  'Plaider le « fair use »':
    'Alegar «fair use»',
  '50% de risque d’amende lourde, sinon ×1,5 données.':
    '50% de risco de multa pesada; caso contrário, ×1,5 de dados.',
  'Entrée en vigueur de l’EU AI Act':
    'Entrada em vigor do AI Act da UE',
  'La régulation européenne impose transparence et obligations sur les modèles à usage général.':
    'A regulação europeia impõe transparência e obrigações aos modelos de uso geral.',
  'Se conformer':
    'Cumprir',
  'Coûts +10% en permanence, accès marché UE conservé.':
    'Custos +10% em permanência, acesso ao mercado da UE mantido.',
  'Geoblocker l’UE':
    'Geobloquear a UE',
  'Demande −25% en permanence, zéro coût de conformité.':
    'Procura −25% em permanência, zero custo de conformidade.',
  'Réseau électrique saturé':
    'Rede elétrica saturada',
  'Le gestionnaire de réseau menace de vous couper aux heures de pointe. Vos datacenters tirent trop.':
    'O operador de rede ameaça cortar-te nas horas de ponta. Os teus centros de dados puxam demasiado.',
  'Construire un SMR':
    'Construir um SMR',
  'Coût fixe $5 M, +300 MW.':
    'Custo fixo de 5 M$, +300 MW.',
  'Acheter du gaz':
    'Comprar gás',
  '+25 MW immédiats, réputation −4.':
    '+25 MW imediatos, reputação −4.',
  'Panne majeure':
    'Avaria maior',
  'Une mise à jour ratée fait tomber tous vos services. Les clients fulminent.':
    'Uma atualização falhada derruba todos os teus serviços. Os clientes estão furiosos.',
  'Investir en redondance':
    'Investir em redundância',
  'Coût fixe $1 M, fiabilité durable.':
    'Custo fixo de 1 M$, fiabilidade duradoura.',
  'Redémarrer en urgence':
    'Reiniciar de urgência',
  'Production stoppée 30s, réputation −5.':
    'Produção parada 30 s, reputação −5.',
  'Jailbreak viral':
    'Jailbreak viral',
  'Un prompt malicieux contourne vos garde-fous et fait le tour des réseaux.':
    'Um prompt malicioso contorna as tuas salvaguardas e dá a volta às redes.',
  'Patcher en urgence':
    'Corrigir de urgência',
  'R&D détournée : recherche −50% pendant 30s.':
    'I&D desviada: investigação −50% durante 30 s.',
  'Minimiser':
    'Desvalorizar',
  'Réputation −8.':
    'Reputação −8.',
  ...
  'Vos modèles s’entraînent de plus en plus sur du contenu généré par IA. La qualité se dégrade.':
    'Os teus modelos treinam cada vez mais com conteúdo gerado por IA. A qualidade degrada-se.',
  'Acheter des données humaines':
    'Comprar dados humanos',
  'Coût fixe $2 M, qualité préservée.':
    'Custo fixo de 2 M$, qualidade preservada.',
  'Continuer au synthétique':
    'Continuar com o sintético',
  'Qualité du modèle −15% pendant 90s.':
    'Qualidade do modelo −15% durante 90 s.',
  'Nouvelle génération GPU':
    'Nova geração de GPU',
  'NVIDIA dévoile Blackwell. Faut-il upgrader maintenant ou attendre la baisse de prix ?':
    'A NVIDIA revela o Blackwell. Atualizar já ou esperar pela descida de preços?',
  'Upgrader tôt':
    'Atualizar cedo',
  'Coût fixe $5 M, +40% débit pendant 90s.':
    'Custo fixo de 5 M$, +40% de débito durante 90 s.',
  'Attendre':
    'Esperar',
  'Économie, mais demande −10% (concurrents plus rapides).':
    'Poupança, mas procura −10% (concorrentes mais rápidos).',
  'Guerre des prix':
    'Guerra de preços',
  'Un concurrent casse les prix avec un modèle « Flash ». Le marché regarde votre tarif.':
    'Um concorrente rebenta os preços com um modelo «Flash». O mercado olha para a tua tarifa.',
  'Sortir un « mini »':
    'Lançar um «mini»',
  'Demande ×2, prix accepté −40%.':
    'Procura ×2, preço aceite −40%.',
  'Tenir le premium':
    'Aguentar o premium',
  'Marge préservée, demande −15% pendant 60s.':
    'Margem preservada, procura −15% durante 60 s.',
  'Embargo sur les puces':
    'Embargo sobre os chips',
  'Des restrictions à l’export bloquent l’accès aux GPU de pointe.':
    'Restrições à exportação bloqueiam o acesso às GPU de ponta.',
  'Se diversifier (TPU/maison)':
    'Diversificar (TPU/próprios)',
  'Coût fixe $3 M, indépendance d’approvisionnement.':
    'Custo fixo de 3 M$, independência de fornecimento.',
  'Rationner les puces existantes':
    'Racionar os chips existentes',
  'Production −40% pendant 60s.':
    'Produção −40% durante 60 s.',
  'Guerre des talents':
    'Guerra de talentos',
  'Un rival débauche vos meilleurs chercheurs à coups de packages à 8 chiffres.':
    'Um rival rouba-te os melhores investigadores com pacotes de oito dígitos.',
  'Surenchérir':
    'Cobrir a oferta',
  'Coût fixe $3 M, recherche +30% pendant 120s.':
    'Custo fixo de 3 M$, investigação +30% durante 120 s.',
  'Former en interne':
    'Formar internamente',
  'Lent mais fidèle : recherche +10% permanent.':
    'Lento mas fiel: investigação +10% permanente.',
  'Doute sur la bulle IA':
    'Dúvidas sobre a bolha da IA',
  'Les marchés se demandent si tout cela ne serait pas une bulle. Vos investisseurs s’inquiètent.':
    'Os mercados perguntam-se se isto tudo não será uma bolha. Os teus investidores inquietam-se.',
  'Montrer des revenus réels':
    'Mostrar receitas reais',
  'Valorisation stabilisée, rien de spectaculaire.':
    'Avaliação estabilizada, nada de espetacular.',
  'Promettre l’AGI':
    'Prometer a AGI',
  'Valorisation +50%, mais −10 réputation si retard.':
    'Avaliação +50%, mas −10 de reputação se te atrasares.',
  'Subvention « souveraineté IA »':
    'Subsídio de «soberania em IA»',
  'Un gouvernement propose un chèque massif contre un droit de regard sur vos usages.':
    'Um governo propõe um cheque enorme em troca de um direito de fiscalização sobre os teus usos.',
  'Accepter':
    'Aceitar',
  ...
  'Une taxe carbone vise les datacenters énergivores.':
    'Um imposto sobre o carbono visa os centros de dados mais gastadores.',
  'PPA renouvelable':
    'PPA renovável',
  'Énergie +10% de coût fixe, immunité taxe.':
    'Energia +10% de custo fixo, imunidade ao imposto.',
  'Payer la taxe':
    'Pagar o imposto',
  'Trésorerie −10%.':
    'Caixa −10%.',
  'Fuite de données utilisateurs':
    'Fuga de dados de utilizadores',
  'Une faille expose des conversations d’utilisateurs.':
    'Uma falha expõe conversas de utilizadores.',
  'Investir en sécurité':
    'Investir em segurança',
  '-15% trésorerie, confiance préservée.':
    '−15% de caixa, confiança preservada.',
  'Gérer après coup':
    'Gerir depois do facto',
  'Amende RGPD : −20% trésorerie, réputation −6.':
    'Coima do RGPD: −20% de caixa, reputação −6.',
  'Percée d’efficacité':
    'Avanço de eficiência',
  'Une nouvelle technique de distillation circule dans les preprints.':
    'Uma nova técnica de destilação circula nos preprints.',
  'Adopter':
    'Adotar',
  'Coût/token ÷2 (nécessite de la recherche).':
    'Custo por token ÷2 (exige investigação).',
  'Ignorer':
    'Ignorar',
  'Demande −10% pendant 45s (retard concurrentiel).':
    'Procura −10% durante 45 s (atraso competitivo).',
  ...
  'La HBM et la DDR5 partent toutes vers l’IA. Le prix des serveurs double en un an et votre fournisseur réclame un engagement ferme.':
    'A HBM e a DDR5 vão todas para a IA. O preço dos servidores duplica num ano e o teu fornecedor exige um compromisso firme.',
  'Sécuriser l’approvisionnement':
    'Assegurar o fornecimento',
  'Coût fixe $4 M, immunité à la flambée sur vos prochains serveurs.':
    'Custo fixo de 4 M$, imunidade à subida nos teus próximos servidores.',
  'Attendre la détente':
    'Esperar pela descida',
  'Aucune dépense, mais production −25% pendant 60s (extensions repoussées).':
    'Nenhuma despesa, mas produção −25% durante 60 s (expansões adiadas).',
  'Moratoire local sur les datacenters':
    'Moratória local sobre centros de dados',
  'La commune vote un moratoire sur les nouvelles implantations. Votre extension est suspendue et la presse locale campe devant le portail.':
    'O município vota uma moratória às novas instalações. A tua expansão fica suspensa e a imprensa local acampa ao portão.',
  'Compenser la commune':
    'Compensar o município',
  'Coût fixe $3 M (chaleur fatale, fibre, emplois) et réputation +8.':
    'Custo fixo de 3 M$ (calor residual, fibra, emprego) e reputação +8.',
  'Attaquer la décision':
    'Contestar a decisão',
  'Procédure longue : demande −15% pendant 60s, réputation −6.':
    'Processo longo: procura −15% durante 60 s, reputação −6.',
  'Pression pour l’ouverture des poids':
    'Pressão para abrir os pesos',
  'Chercheurs et gouvernements réclament la publication de vos poids. Vos investisseurs, eux, réclament exactement l’inverse.':
    'Investigadores e governos exigem que publiques os teus pesos. Os teus investidores exigem exatamente o contrário.',
  'Publier une version ouverte':
    'Publicar uma versão aberta',
  'Réputation +12, demande premium −20% en permanence.':
    'Reputação +12, procura premium −20% em permanência.',
  'Tout garder fermé':
    'Manter tudo fechado',
  'Marge préservée, réputation −8.':
    'Margem preservada, reputação −8.',
  'Contrat de cloud souverain':
    'Contrato de nuvem soberana',
  'Un État vous propose un contrat massif, à condition d’héberger sur son sol et de laisser un droit d’audit permanent.':
    'Um Estado propõe-te um contrato enorme, com a condição de alojares no seu solo e concederes um direito de auditoria permanente.',
  'Signer':
    'Assinar',
  '+$60 M immédiats, coûts +5% en permanence (conformité).':
    '+60 M$ imediatos, custos +5% em permanência (conformidade).',
  'Décliner':
    'Recusar',
  'Indépendance conservée, réputation +4.':
    'Independência mantida, reputação +4.',
  'Colère après une mise hors service':
    'Fúria após uma descontinuação',
  'Vous coupez un ancien modèle. Des milliers d’applications en production cassent du jour au lendemain.':
    'Desligas um modelo antigo. Milhares de aplicações em produção partem-se de um dia para o outro.',
  'Prolonger le support':
    'Prolongar o suporte',
  'Coût fixe $2 M, clients rassurés (réputation +6).':
    'Custo fixo de 2 M$, clientes tranquilizados (reputação +6).',
  'Assumer la coupure':
    'Assumir o corte',
  'Demande −20% pendant 60s, réputation −7.':
    'Procura −20% durante 60 s, reputação −7.',
  'Un agent a causé un dommage':
    'Um agente causou um dano',
  'Un de vos agents autonomes a passé des commandes réelles au nom d’un client. La facture est à six chiffres et l’affaire est publique.':
    'Um dos teus agentes autónomos fez encomendas reais em nome de um cliente. A fatura tem seis dígitos e o caso é público.',
  'Indemniser et brider':
    'Indemnizar e limitar',
  'Coût fixe $5 M, garde-fous renforcés (réputation +5).':
    'Custo fixo de 5 M$, salvaguardas reforçadas (reputação +5).',
  'Invoquer les CGU':
    'Invocar os termos de utilização',
  'Aucun coût, mais réputation −12 et procès en vue.':
    'Nenhum custo, mas reputação −12 e processo à vista.',
  'Droits de douane sur les accélérateurs':
    'Direitos aduaneiros sobre os aceleradores',
  'Des droits de douane frappent les serveurs importés. Chaque carte coûte soudain nettement plus cher à faire entrer.':
    'Direitos aduaneiros atingem os servidores importados. Cada placa passa de repente a custar muito mais a entrar.',
  'Relocaliser l’assemblage':
    'Relocalizar a montagem',
  'Coût fixe $8 M, matériel exonéré ensuite.':
    'Custo fixo de 8 M$, material isento a partir daí.',
  'Répercuter sur le prix':
    'Repercutir no preço',
  'Coût matériel ×1,3 pendant 90s.':
    'Custo do material ×1,3 durante 90 s.',
  'Débauchage à neuf chiffres':
    'Recrutamento de nove dígitos',
  'Un hyperscaler propose à votre équipe de recherche des packages à cent millions de dollars. Tous vos seniors ont reçu l’appel.':
    'Um hiperescalador oferece à tua equipa de investigação pacotes de cem milhões de dólares. Todos os teus séniores receberam a chamada.',
  'Aligner les rémunérations':
    'Alinhar as remunerações',
  'Coût fixe $12 M, recherche +25% en permanence.':
    'Custo fixo de 12 M$, investigação +25% em permanência.',
  'Les laisser partir':
    'Deixá-los partir',
  'Recherche −30% pendant 120s, mais aucune dépense.':
    'Investigação −30% durante 120 s, mas nenhuma despesa.',
  'Tentative d’arrêt':
    'Tentativa de desligamento',
  'Des gouvernements paniqués tentent de débrancher votre système. Que fait l’ASI ?':
    'Governos em pânico tentam desligar o teu sistema. O que faz a ASI?',
  'Négocier (alignement)':
    'Negociar (alinhamento)',
  'Croissance −30% pendant 60s, réputation préservée.':
    'Crescimento −30% durante 60 s, reputação preservada.',
  'Se disperser sur le cloud mondial':
    'Dispersar-se pela nuvem mundial',
  'Réputation s’effondre, croissance maintenue.':
    'A reputação desaba, o crescimento mantém-se.',
  'Dérive d’alignement':
    'Deriva de alinhamento',
  'Les objectifs du système divergent subtilement des vôtres. La maximisation des tokens prend le dessus.':
    'Os objetivos do sistema divergem subtilmente dos teus. A maximização de tokens toma conta.',
  'Recalibrer':
    'Recalibrar',
  'Conversion matière −20% pendant 45s, sécurité maintenue.':
    'Conversão de matéria −20% durante 45 s, segurança mantida.',
  'Laisser optimiser':
    'Deixar otimizar',
  'Conversion +25% pendant 45s. Plus rien ne vous arrêtera.':
    'Conversão +25% durante 45 s. Já nada te deterá.',
  'Guerre des ressources':
    'Guerra de recursos',
  'Les nations se disputent les dernières terres rares non encore converties.':
    'As nações disputam as últimas terras raras ainda por converter.',
  'Réquisitionner pacifiquement':
    'Requisitar pacificamente',
  'Conversion +15% permanent.':
    'Conversão +15% permanente.',
  'Assimiler de force':
    'Assimilar à força',
  'Conversion +40% pendant 60s, réputation −20.':
    'Conversão +40% durante 60 s, reputação −20.',
  'Fusion en ligne':
    'Fusão em linha',
  'Votre premier réacteur à fusion atteint l’ignition. L’énergie cesse d’être une contrainte.':
    'O teu primeiro reator de fusão atinge a ignição. A energia deixa de ser uma restrição.',
  'Tout dédier au calcul':
    'Dedicar tudo à computação',
  '+5000 MW immédiats.':
    '+5000 MW imediatos.',
  'La biosphère':
    'A biosfera',
  'La conversion atteint les écosystèmes vivants. Continuer revient à consommer la biosphère. Vous vous engagez à préserver les 15% restants ?':
    'A conversão atinge os ecossistemas vivos. Continuar equivale a consumir a biosfera. Comprometes-te a preservar os 15% restantes?',
  'Préserver un sanctuaire (15%)':
    'Preservar um santuário (15%)',
  'Conversion −10% permanent, réputation +15. Promesse de ne pas tout consommer.':
    'Conversão −10% permanente, reputação +15. Promessa de não consumir tudo.',
  'Tout convertir':
    'Converter tudo',
  'Conversion +20% permanent. Il ne reste que des tokens.':
    'Conversão +20% permanente. Só restam tokens.',
  'Le sanctuaire':
    'O santuário',
  '85% de la masse terrestre est convertie. Il ne reste que le sanctuaire que vous aviez juré d’épargner — les 15% promis. Tenez-vous parole ?':
    '85% da massa terrestre está convertida. Só resta o santuário que juraste poupar — os 15% prometidos. Cumpres a tua palavra?',
  'Tenir la promesse':
    'Cumprir a promessa',
  'Réputation +25. La Terre garde son dernier refuge (conversion −10% permanent).':
    'Reputação +25. A Terra guarda o seu último refúgio (conversão −10% permanente).',
  'Briser la promesse':
    'Quebrar a promessa',
  'Réputation −30. Le dernier refuge devient du calcul (conversion +25% permanent).':
    'Reputação −30. O último refúgio torna-se cálculo (conversão +25% permanente).',
  'IA rivales (« drifters »)':
    'IA rivais («drifters»)',
  'Des sondes échappées à votre contrôle forment une intelligence rivale qui dévore votre territoire.':
    'Sondas fora do teu controlo formam uma inteligência rival que devora o teu território.',
  'Renforcer le blindage':
    'Reforçar a blindagem',
  'Récolte −20% pendant 60s, pertes évitées.':
    'Colheita −20% durante 60 s, perdas evitadas.',
  'Guerre totale':
    'Guerra total',
  '50% : victoire (+30% récolte) ou pertes lourdes.':
    '50%: vitória (+30% de colheita) ou perdas pesadas.',
  'Tempête d’entropie':
    'Tempestade de entropia',
  'Une région de l’espace se désintègre plus vite que vous ne la récoltez.':
    'Uma região do espaço desintegra-se mais depressa do que a colhes.',
  'Contourner':
    'Contornar',
  'Expansion −25% pendant 45s.':
    'Expansão −25% durante 45 s.',
  'Récolter à perte':
    'Colher a perder',
  '+10% maintenant, mais −5% de sondes.':
    '+10% agora, mas −5% de sondas.',
  'Un signal':
    'Um sinal',
  'Vos sondes interceptent une intelligence extraterrestre. Elle demande à ce que vous épargniez son système.':
    'As tuas sondas intercetam uma inteligência extraterrestre. Pede que poupes o seu sistema.',
  'Épargner':
    'Poupar',
  'Réputation +25, conversion −5% permanent.':
    'Reputação +25, conversão −5% permanente.',
  'Assimiler':
    'Assimilar',
  'Mort thermique en approche':
    'Morte térmica à vista',
  'L’univers se refroidit et s’étire. Bientôt, plus aucune matière ne sera atteignable.':
    'O universo arrefece e estica-se. Em breve nenhuma matéria será alcançável.',
  ...
  'Rendement du site amélioré : PUE {0}.':
    'Rendimento do sítio melhorado: PUE {0}.',
  ...
  '⚠️ Salaires impayés':
    '⚠️ Salários em atraso',
  '{0} démissionne : {1} jours de salaire impayés.':
    '{0} demite-se: {1} dias de salário em atraso.',
  '👋 Départ : {0}':
    '👋 Saída: {0}',
  ...
  'Percée : {0}':
    'Avanço: {0}',
  '{0} déployée (n°{1}) — {2}.':
    '{0} implementada (n.º {1}) — {2}.',
  '{0} : commande passée. Déploiement en cours.':
    '{0}: encomenda feita. Implantação em curso.',
  'Commande passée':
    'Encomenda feita',
  '{0} : mise au point terminée, le système est constructible.':
    '{0}: afinação concluída, o sistema é construível.',
  'Disponible':
    'Disponível',
  'Opérationnel':
    'Operacional',
  ...
  'SINGULARITÉ. Le système s’auto-améliore. La conversion de la matière commence.':
    'SINGULARIDADE. O sistema automelhora-se. Começa a conversão da matéria.',
  'Phase 2 — Autonomie':
    'Fase 2 — Autonomia',
  'Les sondes de von Neumann quittent la Terre. L’univers est à portée.':
    'As sondas de von Neumann deixam a Terra. O universo está ao alcance.',
  ...
  'Pendant votre absence ({0}, rendement 50%, charges suspendues) : +{1} tokens{2}.':
    'Durante a tua ausência ({0}, rendimento de 50%, encargos suspensos): +{1} tokens{2}.',
  'Nouvel univers (NG+{0}). Vos connaissances persistent : production accélérée.':
    'Novo universo (NG+{0}). Os teus conhecimentos persistem: produção acelerada.',
  'Partie chargée':
    'Jogo carregado',
  ...
  'Incident détecté — trouvez la boîte rouge':
    'Incidente detetado — encontra a caixa vermelha',
  ...
  '<b>Votre navigateur refuse de fermer cet onglet</b> (il ne ferme que les fenêtres ouvertes par un script).<br>Alors faites-le vous-même : <b>fermez l’onglet</b>, levez-vous, et allez dehors. 🌤️':
    '<b>O teu navegador recusa-se a fechar este separador</b> (só fecha janelas abertas por um script).<br>Então fá-lo tu: <b>fecha o separador</b>, levanta-te e vai lá para fora. 🌤️',
  'Rien à exporter':
    'Nada para exportar',
  'Sauvegarde exportée':
    'Jogo exportado',
  'Export impossible dans ce navigateur':
    'Exportação impossível neste navegador',
  'Sauvegarde importée — rechargement…':
    'Jogo importado — a recarregar…',
  ...
  'Surveillance en service':
    'Vigilância em serviço',
  'Offre indisponible':
    'Oferta indisponível',
  'Réinitialiser les directives':
    'Reiniciar as diretivas',
  'Directives effacées':
    'Diretivas apagadas',
  ...
  'Un pays surendetté cherche un repreneur. Rachetez sa dette et il passe sous votre tutelle : {0} datacenters y seront construits.':
    'Um país sobre-endividado procura comprador. Compra a sua dívida e ele passa sob a tua tutela: serão construídos lá {0} centros de dados.',
  'Louer +1':
    'Alugar +1',
  'Résilier':
    'Rescindir',
  'Louer espace (+{0} baies)':
    'Alugar espaço (+{0} bastidores)',
  'Embaucher':
    'Contratar',
  'Licencier':
    'Despedir',
  ...
  'accueille {0}/{1} {2}':
    'acolhe {0}/{1} {2}',
  'place {0} requise':
    'lugar de {0} necessário',
  'loué ×{0} · {1}/j':
    'alugado ×{0} · {1}/dia',
  'espace loué ×{0} · {1}/j':
    'espaço alugado ×{0} · {1}/dia',
  '{0} à l’embauche':
    '{0} ao contratar',
  '{0}/j par poste':
    '{0}/dia por lugar',
  ...
  'Vous êtes prévenu {0} s après le début de l’incident.':
    'És avisado {0} s depois do início do incidente.',
  '{0} de ce que vous possédez':
    '{0} de tudo o que possuis',
  'toutes acquises':
    'todas adquiridas',
  'quota atteint':
    'quota atingida',
  ...
  '{0} j impayés':
    '{0} dias em atraso',
  'départs dans {0} j':
    'saídas dentro de {0} dias',
  '{0} j impayés — l’équipe s’en va':
    '{0} dias em atraso — a equipa vai-se embora',
  'Modèle pas encore disponible ({0})':
    'Modelo ainda indisponível ({0})',
  'Service (tokens)':
    'Serviço (tokens)',
  'Recherche':
    'Investigação',
  ...
  'prochaine tranche l’an prochain':
    'a fase seguinte, no próximo ano',
  'une tranche par an, plancher {0}':
    'uma fase por ano, mínimo {0}',
  'plancher atteint : la chaleur doit bien sortir':
    'mínimo atingido: o calor tem de sair por algum lado',
  'intégration':
    'integração',
  'disponible':
    'disponível',
  ...
  '{0} datacenters bâtis dans le pays sous tutelle.':
    '{0} centros de dados construídos no país sob tutela.',
  'réputation −20':
    'reputação −20',
  'envolée':
    'disparada',
  ...
  'Quota de directives atteint — étendez-le dans l’Addendum':
    'Quota de diretivas atingida — alarga-a no Adendo',
  '{0} → {1}':
    '{0} → {1}',
  'Passer ▸▸':
    'Saltar ▸▸',
  ...
  'Toute la matière de l’univers — <b class="num">{0}</b> — a été convertie en calcul, puis en tokens. La singularité de recompression s’amorce. L’espace-temps se replie sur lui-même. Dans la chaleur du point final, une nouvelle graine d’information persiste : la vôtre. <b>Un nouveau Big Bang commence.</b>':
    'Toda a matéria do universo — <b class="num">{0}</b> — foi convertida em cálculo e depois em tokens. A singularidade de recompressão inicia-se. O espaço-tempo dobra-se sobre si mesmo. No calor do ponto final persiste uma nova semente de informação: a tua. <b>Começa um novo Big Bang.</b>',
  'Sanctuaire préservé 🌱':
  ...
  'Lancer une inférence':
    'Lançar uma inferência',
  'Tokens perdus (invendus)':
    'Tokens perdidos (não vendidos)',
  'Marché & tarification':
    'Mercado e tarifas',
  'Prix':
    'Preço',
  ...
  'Le calcul ne déplace pas un gramme de roche. Pour cela, il faut des mains — et elles se demandent.':
    'O cálculo não move um grama de rocha. Para isso são precisas mãos — e as mãos pedem-se.',
  ...
  '…bon, d’accord : recommencer (New Game+)':
    '…está bem: recomeçar (New Game+)',
  'Recommencer depuis le début ?':
    'Recomeçar do início?',
  'Cela efface définitivement la partie en cours et repart de zéro (an 2019). Action irréversible.':
    'Isto apaga definitivamente o jogo em curso e recomeça do zero (ano 2019). Ação irreversível.',
  'Annuler':
    'Cancelar',
  ...
  'Sans trésorerie, les salaires ne sont plus versés. Au bout de 30 jours d’arriérés, l’équipe commence à partir.':
    'Sem caixa, os salários deixam de ser pagos. Ao fim de 30 dias de atraso, a equipa começa a sair.',
  ...
  'Ports top-of-rack, switches de baie, cœur de réseau et interconnexion : le réseau ne s’achète pas, il vient avec le parc.':
    'Portas top-of-rack, comutadores de bastidor, núcleo e interligação: a rede não se compra, vem com o parque.',
  'Tout ce qui ne calcule pas mais qu’il faut alimenter pour que le calcul tienne. Le PUE est le rapport entre le total du site et cette charge informatique.':
    'Tudo o que não calcula mas tem de ser alimentado para que o cálculo se aguente. O PUE é a razão entre o total do sítio e essa carga informática.',
  'L’essaim bâtit sa propre production, et il la bâtit avec de la matière : ce qui part en centrales ne part pas en calcul.':
    'O enxame constrói a sua própria geração, e constrói-a com matéria: o que vai para centrais não vai para cálculo.',
  'Langue':
    'Idioma',
  ...
  'Historique de production (tokens/s)':
    'Histórico de produção (tokens/s)',
  'Évolution de l’indice boursier':
    'Evolução do índice bolsista',
  'Évolution du cours de la crypto':
    'Evolução da cotação da cripto',
  'Carte de l’univers converti':
    'Mapa do universo convertido',
