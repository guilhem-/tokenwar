...
export const GPUS = [
  { id:'consumer', name:'GPU grand public (RTX)', year:2016, perf:1,    energy:0.0004, costBase:50,     costMult:1.07,
    desc:'Une carte gamer detournee pour l inference. On fait avec ce qu on a.' },
  { id:'v100',     name:'NVIDIA V100',            year:2017, perf:6,    energy:0.0003, costBase:800,    costMult:1.08,
    desc:'125 TFLOPS FP16. Le cheval de bataille de 2017.' },
  { id:'a100',     name:'NVIDIA A100 80GB',       year:2020, perf:25,   energy:0.0004, costBase:3.0e4,  costMult:1.075,
    desc:'312 TFLOPS tensor. La carte de l ere GPT-3/4.' },
  { id:'h100',     name:'NVIDIA H100',            year:2023, perf:120,  energy:0.0007, costBase:1.5e6,  costMult:1.075, scarce:true,
    desc:'1979 TFLOPS FP16. Delai de livraison : ~1 an. La penurie fait rage.' },
  { id:'rtx5090',  name:'NVIDIA RTX 5090',        year:2025, perf:10,   energy:0.00065,costBase:2200,   costMult:1.07,
    desc:'Carte grand public Blackwell, 575W. Bon rapport perf/prix.' },
  { id:'rtx6000pro',name:'NVIDIA RTX 6000 Pro (Blackwell)', year:2025, perf:22, energy:0.0006, costBase:8500, costMult:1.075,
    desc:'96 GB GDDR7, 600W. Station de travail pro, tres demandee.' },
  { id:'b200',     name:'NVIDIA B200 (Blackwell)',year:2025, perf:300,  energy:0.001,  costBase:4.0e7,  costMult:1.08,
    desc:'~2,2x H100. La generation datacenter, hors de prix.' },
  { id:'gb200',    name:'Rack GB200 NVL72',       year:2026, perf:25000,energy:0.12,   costBase:2.0e9,  costMult:1.085,
    desc:'72 B200 + 36 Grace CPU, NVLink 1,8 TB/s. ~120 kW par rack.' },
  { id:'rubin',    name:'NVIDIA Rubin R100',      year:2027, perf:6e4,  energy:0.15,   costBase:3.0e9,  costMult:1.085,
    desc:'Generation Rubin : HBM4, interconnexion optique naissante.' },
  { id:'tpu',      name:'TPU v7 Ironwood',        year:2027, perf:6e5,  energy:2.5,    costBase:1.0e11, costMult:1.10, phase:2,
    desc:'Silicium maison, hors penurie NVIDIA. Pods d inference geants.' },
  { id:'feynman',  name:'NVIDIA Feynman F200',    year:2029, perf:1.8e5,energy:0.18,   costBase:8.0e9,  costMult:1.085,
    desc:'Architecture Feynman. Calcul mixte analogique/numerique.' },
  { id:'wafer',    name:'Cluster wafer-scale',    year:2028, perf:2e7,  energy:60,     costBase:5.0e12, costMult:1.10, phase:2,
    desc:'Une galette de silicium entiere = un seul processeur geant.' },
  { id:'vera',     name:'Coeur photonique Vera',  year:2032, perf:7e5,  energy:0.3,    costBase:3.0e10, costMult:1.085,
    desc:'Calcul par la lumiere : la chaleur cesse d etre l ennemi n1.' },
  { id:'aurora',   name:'Maillage Aurora 3D',     year:2037, perf:4e6,  energy:0.6,    costBase:2.0e11, costMult:1.085,
    desc:'Empilement 3D massif, refroidissement immersif.' },
  { id:'helios',   name:'Substrat neuromorphique Helios', year:2043, perf:3e7, energy:0.4, costBase:1.2e12, costMult:1.085,
    desc:'Imite le cerveau : enormement de calcul pour tres peu d energie.' },
  { id:'cryo',     name:'Matrice supraconductrice Cryo', year:2050, perf:3e8, energy:0.2, costBase:8.0e12, costMult:1.085,
    desc:'Supraconductivite ambiante : la dissipation s effondre.' },
  { id:'lumen',    name:'Lattice photonique Lumen', year:2060, perf:3e9, energy:0.8, costBase:5.0e13, costMult:1.085,
    desc:'Reseau optique coherent a l echelle d un batiment.' },
  { id:'quanta',   name:'Coprocesseur quantique-hybride Quanta', year:2072, perf:3e10, energy:1.5, costBase:4.0e14, costMult:1.085,
    desc:'Qubits topologiques epaulant le calcul classique.' },
  { id:'planck',   name:'Processeur limite de Planck', year:2085, perf:3e11, energy:3, costBase:3.0e15, costMult:1.085,
    desc:'On grave a la frontiere physique de l information.' },
  { id:'vacuum',   name:'Coeur a energie du vide Vacuum', year:2098, perf:3e12, energy:0.1, costBase:2.0e16, costMult:1.085,
    desc:'Puise dans l energie du point zero. Fin de la rarete energetique.' },
];

// ---------------------------------------------------------------------
//  CHAINE D'HEBERGEMENT — un GPU doit tenir dans un serveur, dans une baie,
//  dans un datacenter, sur de l'immobilier. capacity = emplacements fournis
//  au niveau enfant ; needs = niveau parent requis ; child = niveau hebergé.
// ---------------------------------------------------------------------
export const INFRA = [
  { id:'realestate', name:'Immobilier', unit:'batiment', child:'datacenter', capacity:4, costBase:30, costMult:1.11,
    desc:'Du garage au campus : il faut bien poser les machines quelque part.' },
  { id:'datacenter', name:'Datacenter', unit:'datacenter', needs:'realestate', child:'rack', capacity:8, costBase:24, costMult:1.10,
    desc:'Salle climatisee. Occupe un emplacement immobilier.' },
  { id:'rack',       name:'Baie (rack)', unit:'baie', needs:'datacenter', child:'server', capacity:12, costBase:15, costMult:1.09,
    desc:'Une armoire 42U. Occupe une place en datacenter.' },
  { id:'server',     name:'Serveur', unit:'serveur', needs:'rack', child:'gpu', capacity:8, costBase:12, costMult:1.08,
    desc:'Chassis accueillant plusieurs GPU. Occupe une place en baie.' },
];
