// Le BOT : comment un joueur compétent joue. Partagé par le simulateur
// d'équilibrage (test-sim.mjs) et le test de sauvegarde (test-save.mjs), pour
// qu'ils exercent exactement la même partie — un test de restauration qui
// jouerait autrement ne prouverait rien sur la vraie.
import { GPUS, ENERGY, PROJECTS, INFRA, OPTIMS, PROGRAMS } from './js/data.js';
import { FUNDING } from './js/game.js';

export function makeBot(game) {
  function bot() {
